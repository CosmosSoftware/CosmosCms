using Cosmos.Cms.Services.Secrets;
...
namespace Cosmos.Tests
{
    ...
    public class CORE_G03_SecretClient_Tests
    {
        ...
        public async Task A06_SecretsClient_NotConfiguredTest()
        {
            ...
            var secretsClient = new SecretsClient(new Cosmos.Cms.Common.Services.Configurations.CosmosStartup() { AllowConfigEdit = false });
